...
export default function TabsLayout() {
  ...
  // href: null hides a tab from the bar (route stays reachable via router.push).
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        <Tabs.Screen name="index" options={{ title: 'Start', tabBarIcon: ({ color, size }) => <LayoutGrid color={color} size={size} /> }} />
        <Tabs.Screen name="home" options={{ title: 'Reserveren', tabBarIcon: ({ color, size }) => <Home color={color} size={size} />, ...hideFor(isCoach) }} />
